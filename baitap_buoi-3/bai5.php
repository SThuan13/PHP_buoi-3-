    ...
    <form action="" method="post">
      ...
      <div class="mb-3 row">
        <div class="col-auto">
          ...
          <button type="button" name="subtract" class="btn btn-info  mb-3">a-b</button>
          <button type="button" name="multiply" class="btn btn-danger mb-3">a*b</button>
          <button type="button" name="divide" class="btn btn-warning mb-3">a/b</button>
        </div>
      </div>
    <div class="output">
      <h1> <?php calculate();?></h1>
